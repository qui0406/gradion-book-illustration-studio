...
## Context Dự án
Web app biến nội dung sách thành chân dung nhân vật + minh họa chương, dùng Gemini API, pipeline 5 bước: Style → Characters → Portraits → Chapters → Illustrations.
